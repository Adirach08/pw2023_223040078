<?php 
    ...
    if (isset($_GET['edit'])) {
        ...
        // $query = "UPDATE categories SET category_name='$category_name', category_image='$category_image' WHERE id = '$category_id';";
					...
					>
						<div class="container-fluid">
							<div class="dashboard-heading">
								...
								<p class="dashboard-subtitle">Create new category list</p>
							</div>
