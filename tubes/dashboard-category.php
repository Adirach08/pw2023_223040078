					...
					>
						<div class="container-fluid">
							...
							<div class="row">
								<div class="col-12">
									<a
										href="./dashboard-category-create.php"
                                        ...
                                        <div class="card card-list d-block">
                                            <div class="card-body">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-md-4">
                                                        <a href="dashboard-category-edit.php?edit=<?php echo $category_item['id'] ?>" class="btn btn-warning">Edit</a>
                                                        <a href="dashboard-category-delete.php?delete=<?php echo $category_item['id'] ?>" class="btn btn-danger" onclick="return confirm('Apakah anda ingin menghapus data ini ?')">Delete</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
